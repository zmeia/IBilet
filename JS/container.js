    ...
    var curent = new  Date().getDay();//gets the day of the week
    ...
    $(".slider div.Prev").append("<p id=\"Prev\">"+ monthNames[mm-1] +"</p>");
    ...
    var DateArr = ['Mo','Tu','We','Th','Fr','Sa','Su']
    ...
    for(let i = Monday,counter=0 ; i < 42+ Monday;i++,counter++){
        if(i<=0){
            switch (counter%7){
                case 0: {$(".container").append("<div id=\"Item"+counter+"\"> "+(daysInMonth(mm-1,yyyy)+i)+"</div>");} break;
                case 1: $(".container").append("<div id=\"Item"+counter+"\"> "+(daysInMonth(mm-1,yyyy)+i)+"</div>"); break;
                case 2: $(".container").append("<div id=\"Item"+counter+"\"> "+(daysInMonth(mm-1,yyyy)+i)+"</div>"); break;
                case 3: $(".container").append("<div id=\"Item"+counter+"\"> "+(daysInMonth(mm-1,yyyy)+i)+"</div>"); break;
                case 4: $(".container").append("<div id=\"Item"+counter+"\"> "+(daysInMonth(mm-1,yyyy)+i)+"</div>"); break;
                case 5: $(".container").append("<div id=\"Item"+counter+"\"> "+(daysInMonth(mm-1,yyyy)+i)+"</div>"); break;
                case 6: $(".container").append("<div id=\"Item"+counter+"\"> "+(daysInMonth(mm-1,yyyy)+i)+"</div>"); break;
                case 7: $(".container").append("<div id=\"Item"+counter+"\"> "+(daysInMonth(mm-1,yyyy)+i)+"</div>"); break;
            }
            ...
            switch (counter%7){
                case 0: {$(".container").append("<div id=\"Item"+counter+"\"> "+(i-daysInMonth(mm,yyyy))+"</div>"); } break;
                case 1: $(".container").append("<div id=\"Item"+counter+"\"> "+(i-daysInMonth(mm,yyyy))+"</div>"); break;
                case 2: $(".container").append("<div id=\"Item"+counter+"\"> "+(i-daysInMonth(mm,yyyy))+"</div>"); break;
                case 3: $(".container").append("<div id=\"Item"+counter+"\"> "+(i-daysInMonth(mm,yyyy))+"</div>"); break;
                case 4: $(".container").append("<div id=\"Item"+counter+"\"> "+(i-daysInMonth(mm,yyyy))+"</div>"); break;
                case 5: $(".container").append("<div id=\"Item"+counter+"\"> "+(i-daysInMonth(mm,yyyy))+"</div>"); break;
                case 6: $(".container").append("<div id=\"Item"+counter+"\"> "+(i-daysInMonth(mm,yyyy))+"</div>"); break;
                case 7: $(".container").append("<div id=\"Item"+counter+"\"> "+(i-daysInMonth(mm,yyyy))+"</div>"); break;
            }
            ...
            switch (counter%7){
            case 0: {$(".container").append("<div id=\"Item"+counter+"\"> "+i+"</div>"); } break;
            case 1: $(".container").append("<div id=\"Item"+counter+"\"> "+i+"</div>"); break;
            case 2: $(".container").append("<div id=\"Item"+counter+"\"> "+i+"</div>"); break;
            case 3: $(".container").append("<div id=\"Item"+counter+"\"> "+i+"</div>"); break;
            case 4: $(".container").append("<div id=\"Item"+counter+"\"> "+i+"</div>"); break;
            case 5: $(".container").append("<div id=\"Item"+counter+"\"> "+i+"</div>"); break;
            case 6: $(".container").append("<div id=\"Item"+counter+"\"> "+i+"</div>"); break;
            case 7: $(".container").append("<div id=\"Item"+counter+"\"> "+i+"</div>"); break;
            }
        }
        //current day background
            $("#Item"+(parseInt(dd))).css("background-image","repeating-linear-gradient(135deg, rgba(0,0,0,0.03) 0px, rgba(0,0,0,0.03) 2px,transparent 2px, transparent 4px),linear-gradient(45deg, rgb(18, 105, 233),rgb(166, 255, 155))");
        }   
    });
    ...
    function UpdateCalendar(Month,Year,dayOfMonth,dayOfWeek){
        ...
        for(let i = Monday,counter=0 ; i < 42+ Monday;i++,counter++){
            if(i<=0){
                switch (counter%7){
                    case 0: $("#Item"+counter).html(daysInMonth(Month-1,Year)+i); break;
                    case 1: $("#Item"+counter).html(daysInMonth(Month-1,Year)+i); break;
                    case 2: $("#Item"+counter).html(daysInMonth(Month-1,Year)+i); break;
                    case 3: $("#Item"+counter).html(daysInMonth(Month-1,Year)+i); break;
                    case 4: $("#Item"+counter).html(daysInMonth(Month-1,Year)+i); break;
                    case 5: $("#Item"+counter).html(daysInMonth(Month-1,Year)+i); break;
                    case 6: $("#Item"+counter).html(daysInMonth(Month-1,Year)+i); break;
                    case 7: $("#Item"+counter).html(daysInMonth(Month-1,Year)+i); break;
                }
                //background of the days before the month
                $("#Item"+counter).css("background-image","linear-gradient(260deg, rgba(84, 84, 84, 0.03) 0%, rgba(84, 84, 84, 0.03) 20%,rgba(219, 219, 219, 0.03) 20%, rgba(219, 219, 219, 0.03) 40%,rgba(54, 54, 54, 0.03) 40%, rgba(54, 54, 54, 0.03) 60%,rgba(99, 99, 99, 0.03) 60%, rgba(99, 99, 99, 0.03) 80%,rgba(92, 92, 92, 0.03) 80%, rgba(92, 92, 92, 0.03) 100%),linear-gradient(147deg, rgba(221, 221, 221, 0.02) 0%, rgba(221, 221, 221, 0.02) 14.286%,rgba(8, 8, 8, 0.02) 14.286%, rgba(8, 8, 8, 0.02) 28.572%,rgba(52, 52, 52, 0.02) 28.572%, rgba(52, 52, 52, 0.02) 42.858%,rgba(234, 234, 234, 0.02) 42.858%, rgba(234, 234, 234, 0.02) 57.144%,rgba(81, 81, 81, 0.02) 57.144%, rgba(81, 81, 81, 0.02) 71.42999999999999%,rgba(239, 239, 239, 0.02) 71.43%, rgba(239, 239, 239, 0.02) 85.71600000000001%,rgba(187, 187, 187, 0.02) 85.716%, rgba(187, 187, 187, 0.02) 100.002%),linear-gradient(211deg, rgba(33, 33, 33, 0.03) 0%, rgba(33, 33, 33, 0.03) 12.5%,rgba(147, 147, 147, 0.03) 12.5%, rgba(147, 147, 147, 0.03) 25%,rgba(131, 131, 131, 0.03) 25%, rgba(131, 131, 131, 0.03) 37.5%,rgba(151, 151, 151, 0.03) 37.5%, rgba(151, 151, 151, 0.03) 50%,rgba(211, 211, 211, 0.03) 50%, rgba(211, 211, 211, 0.03) 62.5%,rgba(39, 39, 39, 0.03) 62.5%, rgba(39, 39, 39, 0.03) 75%,rgba(55, 55, 55, 0.03) 75%, rgba(55, 55, 55, 0.03) 87.5%,rgba(82, 82, 82, 0.03) 87.5%, rgba(82, 82, 82, 0.03) 100%),linear-gradient(450deg, rgba(42, 42, 42, 0.02) 0%, rgba(42, 42, 42, 0.02) 20%,rgba(8, 8, 8, 0.02) 20%, rgba(8, 8, 8, 0.02) 40%,rgba(242, 242, 242, 0.02) 40%, rgba(242, 242, 242, 0.02) 60%,rgba(42, 42, 42, 0.02) 60%, rgba(42, 42, 42, 0.02) 80%,rgba(80, 80, 80, 0.02) 80%, rgba(80, 80, 80, 0.02) 100%),linear-gradient(222deg, rgba(106, 106, 106, 0.03) 0%, rgba(106, 106, 106, 0.03) 14.286%,rgba(67, 67, 67, 0.03) 14.286%, rgba(67, 67, 67, 0.03) 28.572%,rgba(134, 134, 134, 0.03) 28.572%, rgba(134, 134, 134, 0.03) 42.858%,rgba(19, 19, 19, 0.03) 42.858%, rgba(19, 19, 19, 0.03) 57.144%,rgba(101, 101, 101, 0.03) 57.144%, rgba(101, 101, 101, 0.03) 71.42999999999999%,rgba(205, 205, 205, 0.03) 71.43%, rgba(205, 205, 205, 0.03) 85.71600000000001%,rgba(53, 53, 53, 0.03) 85.716%, rgba(53, 53, 53, 0.03) 100.002%),linear-gradient(147deg, rgba(214, 214, 214, 0.03) 0%, rgba(214, 214, 214, 0.03) 16.667%,rgba(255, 255, 255, 0.03) 16.667%, rgba(255, 255, 255, 0.03) 33.334%,rgba(250, 250, 250, 0.03) 33.334%, rgba(250, 250, 250, 0.03) 50.001000000000005%,rgba(231, 231, 231, 0.03) 50.001%, rgba(231, 231, 231, 0.03) 66.668%,rgba(241, 241, 241, 0.03) 66.668%, rgba(241, 241, 241, 0.03) 83.33500000000001%,rgba(31, 31, 31, 0.03) 83.335%, rgba(31, 31, 31, 0.03) 100.002%),linear-gradient(161deg, rgba(224, 224, 224, 0.03) 0%, rgba(224, 224, 224, 0.03) 12.5%,rgba(97, 97, 97, 0.03) 12.5%, rgba(97, 97, 97, 0.03) 25%,rgba(143, 143, 143, 0.03) 25%, rgba(143, 143, 143, 0.03) 37.5%,rgba(110, 110, 110, 0.03) 37.5%, rgba(110, 110, 110, 0.03) 50%,rgba(34, 34, 34, 0.03) 50%, rgba(34, 34, 34, 0.03) 62.5%,rgba(155, 155, 155, 0.03) 62.5%, rgba(155, 155, 155, 0.03) 75%,rgba(249, 249, 249, 0.03) 75%, rgba(249, 249, 249, 0.03) 87.5%,rgba(179, 179, 179, 0.03) 87.5%, rgba(179, 179, 179, 0.03) 100%),linear-gradient(343deg, rgba(58, 58, 58, 0.02) 0%, rgba(58, 58, 58, 0.02) 25%,rgba(124, 124, 124, 0.02) 25%, rgba(124, 124, 124, 0.02) 50%,rgba(254, 254, 254, 0.02) 50%, rgba(254, 254, 254, 0.02) 75%,rgba(52, 52, 52, 0.02) 75%, rgba(52, 52, 52, 0.02) 100%),linear-gradient(192deg, #ffffff,#ffffff)");   
            }
                ...
                switch (counter%7){
                    case 0: $("#Item"+counter).html(i-daysInMonth(Month,Year)); break;
                    case 1: $("#Item"+counter).html(i-daysInMonth(Month,Year)); break;
                    case 2: $("#Item"+counter).html(i-daysInMonth(Month,Year)); break;
                    case 3: $("#Item"+counter).html(i-daysInMonth(Month,Year)); break;
                    case 4: $("#Item"+counter).html(i-daysInMonth(Month,Year)); break;
                    case 5: $("#Item"+counter).html(i-daysInMonth(Month,Year)); break;
                    case 6: $("#Item"+counter).html(i-daysInMonth(Month,Year)); break;
                    case 7: $("#Item"+counter).html(i-daysInMonth(Month,Year)); break;
                }
                //background of the days after the month
                $("#Item"+counter).css("background-image","linear-gradient(260deg, rgba(84, 84, 84, 0.03) 0%, rgba(84, 84, 84, 0.03) 20%,rgba(219, 219, 219, 0.03) 20%, rgba(219, 219, 219, 0.03) 40%,rgba(54, 54, 54, 0.03) 40%, rgba(54, 54, 54, 0.03) 60%,rgba(99, 99, 99, 0.03) 60%, rgba(99, 99, 99, 0.03) 80%,rgba(92, 92, 92, 0.03) 80%, rgba(92, 92, 92, 0.03) 100%),linear-gradient(147deg, rgba(221, 221, 221, 0.02) 0%, rgba(221, 221, 221, 0.02) 14.286%,rgba(8, 8, 8, 0.02) 14.286%, rgba(8, 8, 8, 0.02) 28.572%,rgba(52, 52, 52, 0.02) 28.572%, rgba(52, 52, 52, 0.02) 42.858%,rgba(234, 234, 234, 0.02) 42.858%, rgba(234, 234, 234, 0.02) 57.144%,rgba(81, 81, 81, 0.02) 57.144%, rgba(81, 81, 81, 0.02) 71.42999999999999%,rgba(239, 239, 239, 0.02) 71.43%, rgba(239, 239, 239, 0.02) 85.71600000000001%,rgba(187, 187, 187, 0.02) 85.716%, rgba(187, 187, 187, 0.02) 100.002%),linear-gradient(211deg, rgba(33, 33, 33, 0.03) 0%, rgba(33, 33, 33, 0.03) 12.5%,rgba(147, 147, 147, 0.03) 12.5%, rgba(147, 147, 147, 0.03) 25%,rgba(131, 131, 131, 0.03) 25%, rgba(131, 131, 131, 0.03) 37.5%,rgba(151, 151, 151, 0.03) 37.5%, rgba(151, 151, 151, 0.03) 50%,rgba(211, 211, 211, 0.03) 50%, rgba(211, 211, 211, 0.03) 62.5%,rgba(39, 39, 39, 0.03) 62.5%, rgba(39, 39, 39, 0.03) 75%,rgba(55, 55, 55, 0.03) 75%, rgba(55, 55, 55, 0.03) 87.5%,rgba(82, 82, 82, 0.03) 87.5%, rgba(82, 82, 82, 0.03) 100%),linear-gradient(450deg, rgba(42, 42, 42, 0.02) 0%, rgba(42, 42, 42, 0.02) 20%,rgba(8, 8, 8, 0.02) 20%, rgba(8, 8, 8, 0.02) 40%,rgba(242, 242, 242, 0.02) 40%, rgba(242, 242, 242, 0.02) 60%,rgba(42, 42, 42, 0.02) 60%, rgba(42, 42, 42, 0.02) 80%,rgba(80, 80, 80, 0.02) 80%, rgba(80, 80, 80, 0.02) 100%),linear-gradient(222deg, rgba(106, 106, 106, 0.03) 0%, rgba(106, 106, 106, 0.03) 14.286%,rgba(67, 67, 67, 0.03) 14.286%, rgba(67, 67, 67, 0.03) 28.572%,rgba(134, 134, 134, 0.03) 28.572%, rgba(134, 134, 134, 0.03) 42.858%,rgba(19, 19, 19, 0.03) 42.858%, rgba(19, 19, 19, 0.03) 57.144%,rgba(101, 101, 101, 0.03) 57.144%, rgba(101, 101, 101, 0.03) 71.42999999999999%,rgba(205, 205, 205, 0.03) 71.43%, rgba(205, 205, 205, 0.03) 85.71600000000001%,rgba(53, 53, 53, 0.03) 85.716%, rgba(53, 53, 53, 0.03) 100.002%),linear-gradient(147deg, rgba(214, 214, 214, 0.03) 0%, rgba(214, 214, 214, 0.03) 16.667%,rgba(255, 255, 255, 0.03) 16.667%, rgba(255, 255, 255, 0.03) 33.334%,rgba(250, 250, 250, 0.03) 33.334%, rgba(250, 250, 250, 0.03) 50.001000000000005%,rgba(231, 231, 231, 0.03) 50.001%, rgba(231, 231, 231, 0.03) 66.668%,rgba(241, 241, 241, 0.03) 66.668%, rgba(241, 241, 241, 0.03) 83.33500000000001%,rgba(31, 31, 31, 0.03) 83.335%, rgba(31, 31, 31, 0.03) 100.002%),linear-gradient(161deg, rgba(224, 224, 224, 0.03) 0%, rgba(224, 224, 224, 0.03) 12.5%,rgba(97, 97, 97, 0.03) 12.5%, rgba(97, 97, 97, 0.03) 25%,rgba(143, 143, 143, 0.03) 25%, rgba(143, 143, 143, 0.03) 37.5%,rgba(110, 110, 110, 0.03) 37.5%, rgba(110, 110, 110, 0.03) 50%,rgba(34, 34, 34, 0.03) 50%, rgba(34, 34, 34, 0.03) 62.5%,rgba(155, 155, 155, 0.03) 62.5%, rgba(155, 155, 155, 0.03) 75%,rgba(249, 249, 249, 0.03) 75%, rgba(249, 249, 249, 0.03) 87.5%,rgba(179, 179, 179, 0.03) 87.5%, rgba(179, 179, 179, 0.03) 100%),linear-gradient(343deg, rgba(58, 58, 58, 0.02) 0%, rgba(58, 58, 58, 0.02) 25%,rgba(124, 124, 124, 0.02) 25%, rgba(124, 124, 124, 0.02) 50%,rgba(254, 254, 254, 0.02) 50%, rgba(254, 254, 254, 0.02) 75%,rgba(52, 52, 52, 0.02) 75%, rgba(52, 52, 52, 0.02) 100%),linear-gradient(192deg, #ffffff,#ffffff)");
            }
                ...
                switch (counter%7){
                    case 0: $("#Item"+counter).html(i); break;
                    case 1: $("#Item"+counter).html(i); break;
                    case 2: $("#Item"+counter).html(i); break;
                    case 3: $("#Item"+counter).html(i); break;
                    case 4: $("#Item"+counter).html(i); break;
                    case 5: $("#Item"+counter).html(i); break;
                    case 6: $("#Item"+counter).html(i); break;
                    case 7: $("#Item"+counter).html(i); break;
                }
            ...
            //current day background;
            if(initialMonth==Month && initialYear == Year) $("#Item" + parseInt(dd)).css("background-image","repeating-linear-gradient(135deg, rgba(0,0,0,0.03) 0px, rgba(0,0,0,0.03) 2px,transparent 2px, transparent 4px),linear-gradient(45deg, rgb(18, 105, 233),rgb(166, 255, 155))");
